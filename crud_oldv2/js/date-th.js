 ...
 *    $('#example').dataTable( {
 *       columnDefs: [
 *         { type: 'th_datetime', targets: 0 },
 *         { type: 'th_date', targets: 1 }
 *       ]
 *    } );
 */

jQuery.extend( jQuery.fn.dataTableExt.oSort, {
	"th_datetime-asc": function ( a, b ) {
		var x, y;
		if (jQuery.trim(a) !== '') {
